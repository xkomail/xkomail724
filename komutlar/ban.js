...
exports.run = (client, message, args) => {
  ...
  .addField(':warning: Uyarı :warning:', '`ban` adlı komutu özel mesajlarda kullanamaya yetkin yok.')
  ...
  if (!message.guild.member(user).bannable) return message.reply('Yetkilileri banlayamam krdş.');
